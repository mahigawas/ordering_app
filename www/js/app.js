...
app = angular.module('orderingApp', ['ionic','orderingApp.controllers','orderingApp.services','orderingApp.factories','jett.ionic.filter.bar','ngOpenFB', 'pascalprecht.translate', 'ui.select', 'ngSanitize', 'ionic-modal-select'])
    ...
    .config(function($stateProvider, $urlRouterProvider, $translateProvider, $resourceProvider) {
        ...
        $translateProvider.translations('ar', {
            ...
            'Register Failed! please try again later.': 'لم يتم التسجيل، الرجاء الموحاولة مرة اخرى',
            ...
            'OK': 'نعم',
            'IQD': 'د.ع.',
            'Add any special instructions': 'اضافة اي تعليمات خاصة، مثلا تريد البيبسي دايت، لو تريد السندوج بدون مايونيز',
            'Select your Area': 'المنطقة التي انت فيها',
            'Rating': 'تصنيف',
            'Facebook': 'فيسبوك',
            'Youtube': 'يوتيوب',
            ...
            'Delivery time is 60 min' : 'وقت التوصيل من ٣٠ الى ٦٠ دقيقة',
